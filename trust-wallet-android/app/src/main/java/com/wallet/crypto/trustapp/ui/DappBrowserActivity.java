...
public class DappBrowserActivity extends BaseActivity {
    ...
    public static final String TAG = "hyh_dappbrowser-";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        urlText.setText("https://js-eth-sign.surge.sh");
    ...
    private void initWeb3View(){
        ...
        web3View.setWebContentsDebuggingEnabled(true);
        ...
        web3View.setOnSignMessageListener(message -> {
            Log.d(TAG,
                    "setOnSignMessageListener  url= " + message.url + " value= "+ message.value + " leafPosition= "+ message.leafPosition);
        });

        web3View.setOnSignPersonalMessageListener(message -> {
            Log.d(TAG,
                    "setOnSignPersonalMessageListener  url= " + message.url + " value= "+ message.value + " leafPosition= "+ message.leafPosition);
        });
